...
import { mdHomeWomen, mubileHomeWomen, xlHomeWomen, mdConsultant, mubileConsultant, xlConsultant } from "../assets/utlity";
    ...
    return (
        <div>
            ...
            <div className="flex flex-col md:flex-row md:h-[600px] xl:h-[900px]">
                <div className="text-start p-5 font-ibmPlex md:flex flex-col items-start justify-start md:my-5">
                ...
                {/* xl */}
                <img src={xlHomeWomen} alt="women image" className="hidden xl:block w-[600px] object-contain opacity-50" />
                {/* md */}
