...
export const TechCard: FC<ProductCardProps> = ({ item }) => {
    return (
        ...
        <div className="w-full group h-[319px] md:h-[200px] lg:h-[218px] md:w-boxWidth  relative transition-all  ease-in-out p-boxP border border-gary-500 flex-shrink-0">
